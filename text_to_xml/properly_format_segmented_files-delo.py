...
def change_header_part(tree, original_filename):
    ...
    base_out_filename = "./testing_formatting_headers_delo_popravki/"+original_filename
...
def upgrade_header(original_filename, tree):
    ...
    for textClass in root.iter('{http://www.tei-c.org/ns/1.0}textClass'):
        ...
        catref = ET.SubElement(textClass, '{http://www.tei-c.org/ns/1.0}catRef', attrib={'target':"segment:??TO-ADD??"})
...
"""                 
"""
folder = './testing_proper_formatting_delo_popravki/'
out_folder = './testing_formatting_headers_delo_popravki/'
trees = {}
...
for filename in files_in_segmented_folder:
    ...
    lines_in_curr_segment = []
    current_segment = 1
    base_out_filename = "./testing_proper_formatting_delo_popravki_pregled-verzija-1/"+base_filename
    parsed_gigafida = parse_gigafida(gigafida_filename)
    """
    while True:
        e = parsed_gigafida[0]
